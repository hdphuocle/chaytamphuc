    ...
    function f(c, e) {
        ...
        if ("bulletedListStyle" == e) return {
            title: b.bulletedTitle, minWidth: 300, minHeight: 50, getModel: h(c, "ul"), contents: [{
                id: "info", accessKey: "I", elements: [{
                    ...
                    align: "center",
                    style: "width:150px",
                    items: [[b.notset, ""], [b.circle, "circle"], [b.disc, "disc"], [b.square,
                        "square"]],
                    setup: function (a) {
        ...
        if ("numberedListStyle" == e) {
            var f = [[b.notset, ""], [b.lowerRoman, "lower-roman"], [b.upperRoman,
                "upper-roman"], [b.lowerAlpha, "lower-alpha"], [b.upperAlpha, "upper-alpha"], [b.decimal, "decimal"]];
            return {
                    ...
                    id: "info", accessKey: "I", elements: [{
                        type: "hbox", widths: ["25%", "75%"], children: [{
                            ...
                            commit: function (a) {
                                ...
                                a = b;
                                b = c;
                                for (d = isNaN(d) ? 1 : d; (a = a.getNext(g)) && b++;) a.getAttribute("value") == b && a.setAttribute("value", d + b - c)
                            }
                        }, {
                            type: "select",
                            label: b.type,
